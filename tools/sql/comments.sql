CREATE TABLE IF NOT EXISTS  `udwbase_comments` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=248 DEFAULT CHARSET=utf8 COMMENT='UDWBase Comments Table';

CREATE TABLE IF NOT EXISTS  `udwbase_comments_rates` (
